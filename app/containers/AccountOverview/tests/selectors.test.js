...
describe('selectAccountOverview', () => {
  it('should select the AccountOverview state', () => {
    ...
    expect(selectAccountOverview(mockedState)).toEqual(accountOverviewState);
  });
});

describe('makeSelectAccountInfo', () => {
  const transactionSelector = makeSelectAccountInfo();
  it('should select and sort the accountInfo', () => {
    ...
    expect(transactionSelector(state)).toEqual(sortedTransactions);
  });
});

describe('makeSelectCurrentBalance', () => {
  const balanceSelector = makeSelectCurrentBalance();
  it('should select and sort the makeSelectAccountInfo', () => {
    const currentBalance = '-4.836,77';

    expect(balanceSelector(state)).toEqual(currentBalance);
  });
});
