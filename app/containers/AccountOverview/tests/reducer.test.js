import accountOverviewReducer, { initialState } from '../reducer';
import { fetchAccountSucceeded } from '../actions';

/* eslint-disable default-case, no-param-reassign */
describe('accountOverviewReducer', () => {
  let state;
  beforeEach(() => {
    state = initialState;
  });
  ...
  it('should return the initial state', () => {
    expect(accountOverviewReducer(undefined, {})).toEqual(state);
  });
